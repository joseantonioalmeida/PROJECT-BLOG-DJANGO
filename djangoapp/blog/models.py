...
class Tag(models.Model):
    ...
    )# é um texto que vai representar a url
...
class Post(models.Model):
    ...
    excerpt = models.CharField(max_length=150, help_text='Resuma seu post.')
    is_published = models.BooleanField(
        default=False,
        help_text='Este campo precisará estar sempre marcado para ser exibida publicamente.'
    )
    content = models.TextField()
    ...
    cover_in_post_content = models.BooleanField(
        default=True,
        help_text='Exibe a imagem da capa também dentro do conteúdo do post?'
    )
